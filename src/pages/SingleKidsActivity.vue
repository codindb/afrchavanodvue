   ...
   <el-container>
      ...
      <el-main class="overlapping page-main">
         <div class="overlapping-content" v-loading="apiData.areKidsActivitiesLoading">
            ...
            <h3>Informations</h3>
            <div v-if="apiData.singleKidsActivity" v-html="markdownToHtml(apiData.singleKidsActivity.info_supplementaire)"></div>
            <h3>Contact</h3>
...
.el-header {
   background: linear-gradient(180deg, #9cc22b, #ffffff);
}
</style>